...
$(document).ready(function() {
    ...
    console.log($cell.context);             // jQuery().context removed in jQuery 3.0+
    console.log($cell.selector);            // jQuery().selector removed in jQuery 3.0+
    console.log($cell.prevObject);          // jQuery().prevObject not defined with direct selector
});
