...
$entries = array(
    'FAITH' => array(
        'part' => 'n.',
        'definition' => 'Belief without evidence is what is told by one who speaks without knowledge, of things without parallel.'
    ),
    'FAMOUS' => array(
        'part' => 'adj.',
        'definition' => 'Conspicuously miserable.',
        'quote' => array(
            'Done to a tuen on the iron, behold',
            'Him who to be famous aspired',
            'Content? Well, his grill has a plating of gold,',
            'And his twistings are greatly admired.',
        ),
        'author' => 'Hassan Brbuddy'
    ),
    'FELON' => array(
        'part' => 'n.',
        'definition' => 'A person of greater enterprise than discretion, who is embracing an opportunity has formed an unfortunate attachment.',
    ),
    'FIDDLE' => array(
        'part' => 'n.',
        'definition' => 'An instrument to tickle human ears by friction of a horse\'s tail on the entails of a cat.',
        'quote' => array(
    ...
    'FLOP' => array(
        'part' => 'v.',
        'definition' => 'Suddenly to change one\'s opinions and go over to another party. The most notable flop on record was that of Saul of Tarsus, who has been severely criticised as a turn-coat by some of our partisan journalist.',
    ),
    'FORCE' => array(
        'part' => 'n.',
        'definition' => '',
    ...
    'FORGETFULNESS' => array(
        'part' => 'n.',
        'definition' => 'A gift of God bestowed upon doctors in compensation for their destruction of conscience.',
    ),
    'FRIENDLESS' => array(
        'part' => 'adj.',
