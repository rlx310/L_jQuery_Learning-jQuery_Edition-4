...
$entries = array(
    'EAVESDROP' => array(
        'part' => 'v.i.',
        'definition' => 'Secretly to overhear a catalogue of the cromes and vices of another or yourself.',
        'quote' => array(
    ...
    'ELOQUENCE' => array(
        'part' => 'n.',
        'definition' => 'The art of orally persuading fools that white is the color that it appears to be. It includes the gifs of making any color appear white.',
    ),
    'ELYSIUM' => array(
        'part' => 'n.',
        'definition' => 'An imaginary delightful county which the ancient spirits of the good. This is ridiculous and mischievous fable was swept off the face of the earth by the early Christians &mdash; may their souls be happy in Heaven!',
    ),
    'EMANCIPATION' => array(
        'part' => 'n.',
...
if (isset($entries[strtoupper($_REQUEST['term'])])) {
    ...
    echo '<div>Sorry, your terms was not found.</div>';
}
